    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_number') ? 'is-invalid' : '' }}" type="text" name="id_number" id="id_number" value="{{ old('id_number', $user->id_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('department') ? 'is-invalid' : '' }}" type="text" name="department" id="department" value="{{ old('department', $user->department) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qualification') ? 'is-invalid' : '' }}" type="text" name="qualification" id="qualification" value="{{ old('qualification', $user->qualification) }}">
            ...
            <div class="form-group">
                <label for="year">{{ trans('cruds.user.fields.year') }}</label>
                <input class="form-control {{ $errors->has('year') ? 'is-invalid' : '' }}" type="number" name="year" id="year" value="{{ old('year', $user->year) }}" step="1">
                @if($errors->has('year'))
            ...
            <div class="form-group">
                <label for="student">{{ trans('cruds.user.fields.student') }}</label>
                <input class="form-control {{ $errors->has('student') ? 'is-invalid' : '' }}" type="text" name="student" id="student" value="{{ old('student', $user->student) }}">
                @if($errors->has('student'))
                    <span class="text-danger">{{ $errors->first('student') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.user.fields.student_helper') }}</span>
            </div>
            <div class="form-group">
