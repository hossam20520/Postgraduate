    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('degree') ? 'is-invalid' : '' }}" type="text" name="degree" id="degree" value="{{ old('degree', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('student') ? 'is-invalid' : '' }}" type="text" name="student" id="student" value="{{ old('student', '') }}">
