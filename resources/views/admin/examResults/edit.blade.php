...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.examResult.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.exam-results.update", [$examResult->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('student') ? 'is-invalid' : '' }}" name="student_id" id="student_id">
                    @foreach($students as $id => $entry)
                        <option value="{{ $id }}" {{ (old('student_id') ? old('student_id') : $examResult->student->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('math') ? 'is-invalid' : '' }}" type="number" name="math" id="math" value="{{ old('math', $examResult->math) }}" step="1">
                @if($errors->has('math'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('database') ? 'is-invalid' : '' }}" type="number" name="database" id="database" value="{{ old('database', $examResult->database) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('programming_1') ? 'is-invalid' : '' }}" type="text" name="programming_1" id="programming_1" value="{{ old('programming_1', $examResult->programming_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('software_engineer') ? 'is-invalid' : '' }}" type="number" name="software_engineer" id="software_engineer" value="{{ old('software_engineer', $examResult->software_engineer) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('computer_science') ? 'is-invalid' : '' }}" type="number" name="computer_science" id="computer_science" value="{{ old('computer_science', $examResult->computer_science) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total') ? 'is-invalid' : '' }}" type="number" name="total" id="total" value="{{ old('total', $examResult->total) }}" step="1">
                @if($errors->has('total'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rating') ? 'is-invalid' : '' }}" type="text" name="rating" id="rating" value="{{ old('rating', $examResult->rating) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('database_2') ? 'is-invalid' : '' }}" type="number" name="database_2" id="database_2" value="{{ old('database_2', $examResult->database_2) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('programming_2') ? 'is-invalid' : '' }}" type="number" name="programming_2" id="programming_2" value="{{ old('programming_2', $examResult->programming_2) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('statistics') ? 'is-invalid' : '' }}" type="number" name="statistics" id="statistics" value="{{ old('statistics', $examResult->statistics) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('selected') ? 'is-invalid' : '' }}" type="text" name="selected" id="selected" value="{{ old('selected', $examResult->selected) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('project') ? 'is-invalid' : '' }}" type="text" name="project" id="project" value="{{ old('project', $examResult->project) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_p') ? 'is-invalid' : '' }}" type="number" name="total_p" id="total_p" value="{{ old('total_p', $examResult->total_p) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('overall_rating') ? 'is-invalid' : '' }}" type="text" name="overall_rating" id="overall_rating" value="{{ old('overall_rating', $examResult->overall_rating) }}">
